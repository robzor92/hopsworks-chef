...
<<<<<<< HEAD
  `json_config` varchar (11500) COLLATE latin1_general_cs NOT NULL,
  `json_config` varchar (1000) COLLATE latin1_general_cs NOT NULL,
=======
  `job_config` varchar(10000) COLLATE latin1_general_cs DEFAULT NULL,
  `docker_config` varchar(2000) COLLATE latin1_general_cs DEFAULT NULL,
>>>>>>> fix
